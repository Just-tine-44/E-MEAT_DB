...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2025 at 10:33 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetSalesOverview` ()   BEGIN
    ...
    SELECT SUM(TOTAL_AMOUNT) AS total_sales_all_time
    FROM ORDERS
    WHERE STAT_ID IS NOT NULL; -- Assuming STAT_ID is not null for completed orders

    -- Total sales for the last 1 day
    SELECT SUM(TOTAL_AMOUNT) AS total_sales_last_1_day
    FROM ORDERS
    WHERE STAT_ID IS NOT NULL
      AND ORDERS_DATE >= CURDATE() - INTERVAL 1 DAY;

    -- Total sales for today
    SELECT SUM(TOTAL_AMOUNT) AS total_sales_today
    FROM ORDERS
    WHERE STAT_ID IS NOT NULL
      AND ORDERS_DATE = CURDATE();
END$$
...
CREATE TABLE `meat_part` (
  ...
  `MEAT_PART_PHOTO` varchar(30) NOT NULL,
...
(1, 2, 1, 'Cubed Beefs', 'Cube beefs.png', 164, 'kg', 155.00),
(2, 2, 3, 'Breast', 'Breast.png', 165, 'kg', 123.00),
(3, 2, 2, 'Pork Ribs', 'Pork Ribs.png', 220, 'kg', 215.00);
...
(1, 1, 1, 2, 2, '2025-03-09 13:29:43', 415.00, '2025-03-09 12:57:02', 2),
(2, 1, 2, 3, 4, '2025-03-09 14:57:45', 383.00, '2025-03-09 12:56:05', 2),
(3, 1, 1, 3, 4, '2025-03-09 14:59:59', 205.00, '2025-03-09 12:56:14', 2),
(4, 1, 2, 2, 3, '2025-03-09 16:34:13', 670.00, '2025-03-09 12:56:21', 2),
(5, 1, 1, 1, 3, '2025-03-09 17:37:16', 220.50, '2025-03-09 12:56:27', 2),
(6, 1, 1, 2, 3, '2025-03-09 19:12:02', 586.80, '2025-03-09 12:56:32', 2),
(7, 1, 1, 3, 3, '2025-03-09 19:43:09', 383.00, '2025-03-09 12:56:36', 2),
(8, 1, 2, 2, 3, '2025-03-09 19:58:43', 236.00, '2025-03-09 12:56:41', 2),
(9, 1, 1, 1, 3, '2025-03-09 20:11:12', 625.00, '2025-03-09 12:56:46', 2),
(10, 1, 1, NULL, 1, '2025-03-09 22:42:40', 570.00, '2025-03-09 14:42:40', NULL),
(11, 1, 2, NULL, 1, '2025-03-09 22:48:56', 260.00, '2025-03-09 14:48:56', NULL),
(12, 1, 1, NULL, 1, '2025-03-09 22:55:06', 383.00, '2025-03-09 14:55:06', NULL),
(13, 3, 2, NULL, 1, '2025-03-10 04:34:50', 446.00, '2025-03-09 20:34:50', NULL),
(14, 3, 1, NULL, 1, '2025-03-10 04:35:28', 538.00, '2025-03-09 20:35:28', NULL),
(15, 3, 1, NULL, 1, '2025-03-10 04:36:14', 1026.00, '2025-03-09 20:36:14', NULL);
...
(1, 1, 1, 1, 'KG', 155.00, 155.00),
(2, 1, 3, 1, 'KG', 210.00, 210.00),
(3, 2, 3, 1, 'KG', 210.00, 210.00),
(4, 2, 2, 1, 'KG', 123.00, 123.00),
(5, 3, 1, 1, 'KG', 155.00, 155.00),
(6, 4, 1, 4, 'KG', 155.00, 620.00),
(7, 5, 1, 100, 'G', 155.00, 15.50),
(8, 5, 1, 1, 'KG', 155.00, 155.00),
(9, 6, 1, 1, 'KG', 155.00, 155.00),
(10, 6, 3, 1, 'KG', 210.00, 210.00),
(11, 6, 2, 1, 'KG', 123.00, 123.00),
(12, 6, 1, 100, 'G', 155.00, 15.50),
(13, 6, 3, 100, 'G', 210.00, 21.00),
(14, 6, 2, 100, 'G', 123.00, 12.30),
(15, 7, 3, 1, 'KG', 210.00, 210.00),
(16, 7, 2, 1, 'KG', 123.00, 123.00),
(17, 8, 1, 1, 'KG', 155.00, 155.00),
(18, 8, 1, 200, 'G', 155.00, 31.00),
(19, 9, 3, 2, 'KG', 210.00, 420.00),
(20, 9, 1, 1, 'KG', 155.00, 155.00),
(21, 10, 1, 2, 'KG', 155.00, 310.00),
(22, 10, 3, 1, 'KG', 210.00, 210.00),
(23, 11, 3, 1, 'KG', 210.00, 210.00),
(24, 12, 3, 1, 'KG', 210.00, 210.00),
(25, 12, 2, 1, 'KG', 123.00, 123.00),
(26, 13, 2, 1, 'KG', 123.00, 123.00),
(27, 13, 3, 1, 'KG', 210.00, 210.00),
(28, 13, 3, 300, 'G', 210.00, 63.00),
(29, 14, 1, 1, 'KG', 155.00, 155.00),
(30, 14, 2, 1, 'KG', 123.00, 123.00),
(31, 14, 3, 1, 'KG', 210.00, 210.00),
(32, 15, 3, 2, 'KG', 210.00, 420.00),
(33, 15, 2, 2, 'KG', 123.00, 246.00),
(34, 15, 1, 2, 'KG', 155.00, 310.00);
...
--
ALTER TABLE `meat_part`
  MODIFY `MEAT_PART_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
